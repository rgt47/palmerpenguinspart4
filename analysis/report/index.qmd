...
This post walks through the four classical regression
assumptions, checks each with both visual and formal
tests, identifies influential observations, and
interprets the model coefficients in biological terms.
