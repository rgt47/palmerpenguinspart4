...
description: >
  Verifying regression model trustworthiness through
  systematic diagnostic checks on linearity, normality,
  and influence.
...
linear model generalises well, with a cross-validated
...
- General discussion of statistical modelling for
  ecological data
...
1. Post 50: [Palmer Penguins Part 1: Exploratory Data Analysis](../50-palmerpenguinspart1/)
2. Post 51: [Palmer Penguins Part 2: Multiple Regression](../51-palmerpenguinspart2/)
3. Post 52: [Palmer Penguins Part 3: Cross-Validation](../52-palmerpenguinspart3/)
4. **Post 53: Palmer Penguins Part 4: Model Diagnostics** (this post)
5. Post 54: [Palmer Penguins Part 5: Random Forest versus Linear](../54-palmerpenguinspart5/)
6. Post 55: [Predictive Modeling of Penguin Body Mass](../55-palmerpenguinsregression/)
7. Post 56: [Functional Plot Generation with purrr](../56-plotsfrompurrr/)
